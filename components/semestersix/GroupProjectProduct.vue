<template>
  <section>
    ...
    <div class="row-grid">
          <NuxtLink class="modal-link" to="/modals/semesterSix/orientation" data_category="grp_design">
          ...
          <NuxtLink class="modal-link" to="/modals/semesterSix/orientation" data_category="grp_realise">
            <div class="overview-grid" :style="{ backgroundImage: `url('icon.png')`}">
              <div>
                <a class="a-ghostbtn">
                  <div id="hover-box" class="hover-box">
          ...
          <NuxtLink class="modal-link" to="/modals/semesterSix/orientation" data_category="grp_advise grp_design">
            <div class="overview-grid" :style="{ backgroundImage: `url('icon.png')`}">
              <div>
                <a class="a-ghostbtn">
                  <div id="hover-box" class="hover-box">
          ...
          <NuxtLink class="modal-link" to="/modals/semesterSix/orientation" data_category="grp_analyse">
            <div class="overview-grid" :style="{ backgroundImage: `url('icon.png')`}">
              <div>
                <a class="a-ghostbtn">
                  <div id="hover-box" class="hover-box">
...
section{
   justify-content: center;
    ...
    .filters li:nth-child(odd), .filters li:nth-child(even) {
    justify-self: center;
  }
  .filters label{
    font-size: 1rem;
